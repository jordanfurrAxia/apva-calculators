...
function generatePDFPageOne() {
	...
	<div id="page1content" style="margin:0; display:flex; flex-direction:column; position:absolute; top:250px; width:596px; height:591px; justify-content:center; align-items:center;">
		<div id="annualContainer" style="position:relative; border-radius:5px; width:526px; margin:0; margin-top:40px; display:flex; flex-direction:column; justify-content:center; align-items:center;">
			<div id="annualTitle" style="top:${titleTop}; left:${titleLeft}; border-radius:6px; background:${blueColor}; color:white; font-size:${titleFontSize}; font-weight:700; position:absolute; padding:${titlePadding}; border-bottom: 1px solid white;">
		...
		<div id="initialContainer" style="position:relative; width:526px; margin:0; margin-top:${marginTop}; display:flex; flex-direction:column; justify-content:center; align-items:center;">
			<div id="initialTitle" style="top:${titleTop}; left:${titleLeft}; background:${accentColor}; position:absolute; color:white; border-radius:6px; font-size:${titleFontSize}; font-weight:700; padding:${titlePadding}; border-bottom: 1px solid white;">
		...
		<div id="bonusContainer" style="position:relative; border-radius:5px; width:526px; margin:0; margin-top:${marginTop}; display:flex; flex-direction:column; justify-content:center; align-items:center;">
			<div id="bonusTitle" style="top:${titleTop}; left:${titleLeft}; border-radius:6px; color:white; background:${accentColor}; position:absolute; font-size:${titleFontSize}; font-weight:700; padding:${titlePadding}; border-bottom: 1px solid white;">
		...
		<div id="deferralContainer" style="position:relative; width:526px; margin:0; margin-top:${marginTop}; display:flex; flex-direction:column; justify-content:center; align-items:center;">
			<div id="deferralTitle" style="top:${titleTop}; left:${titleLeft}; background:${accentColor}; position:absolute; color:white; border-radius:6px; font-size:${titleFontSize}; font-weight:700; padding:${titlePadding}; border-bottom: 1px solid white;">
		...
		<div id="lifetimeContainer" style="position:relative; border-radius:5px; width:526px; margin:0; margin-top:${marginTop}; display:flex; flex-direction:column; justify-content:center; align-items:center;">
			<div id="lifetimeTitle" style="top:${titleTop}; left:${titleLeft}; border-radius:6px; background:${accentColor}; color:white; font-size:${titleFontSize}; font-weight:700; position:absolute; padding:${titlePadding}; border-bottom: 1px solid white;">
